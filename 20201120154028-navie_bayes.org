...
这里如果想要构建一个 [[file:20201120153417-generative_learning_algorithm.org][Generative model]]，即拟合 $p(x|y)$ 。
...
使用[[file:20201103085205-maximum_likelihood_estimation.org][极大似然法]]计算使得 $s(x^{(i)},y^{)i})$ 发生概率最大的参数：
