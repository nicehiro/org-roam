...
#+roam_alias:
#+roam_tags: kernel machine-learning

* Description
之前[[file:20201103094403-linear_regression.org][线性回归]]讲了如何用线性函数去拟合数据，那么当数据比较复杂，
...
之前 [[file:20201103101941-lms_least_mean_squares.org][LMS]] 更新方程如下：
\begin{equation*}
\begin{aligned}
...
这表明 $K$ 是一个[[file:20201216113346-positive_semi_definite_matrix.org][半正定矩阵]]。
