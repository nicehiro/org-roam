...
#+OPTIONS: toc:nil
#+roam_alias:
#+roam_tags: machine-learning classfication
...
我们可以忽略标签是离散的，然后直接将线性回归算法应用到分类问题上，例如[[file:20201102213824-linear_classification.org][Linear Classification]]。
...
我们的目标是要使得真实分类的概率越大越好，运用[[file:20201103085205-maximum_likelihood_estimation.org][Maximum likelihood Estimation]]，得到：
...
运用[[file:20201103101531-gradient_descent.org][Gradient Descent]]不断更新参数：
